...
[git-apt-install.mp4](http://github.liaoxuefeng.com/sinaweibopy/video/git-apt-install.mp4)

<video width="638" height="478" controls="">
<source src="../video/chapter2/git-apt-install.mp4">
...
![install-git-by-xcode](../image/chapter2/2-1.jpg)
...
![install-git-on-windows](../image/chapter2/2-2.jpg)
