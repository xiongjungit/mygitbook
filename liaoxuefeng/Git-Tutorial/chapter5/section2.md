...
![github-init-repo](../image/chapter5/5-2-1.jpg)

我们勾选Initialize this repository with a README，这样GitHub会自动为我们创建一个README.md文件。创建完毕后，可以看到README.md文件：

![github-init-repo-2](../image/chapter5/5-2-2.jpg)
...
[git-clone.mp4](http://github.liaoxuefeng.com/sinaweibopy/video/git-clone.mp4)

<video controls="" height="434" width="648">
<source src="../video/chapter5/git-clone.mp4">
