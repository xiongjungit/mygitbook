...
分布式MinIO可以通过 [Docker Compose](http://docs.minio.org.cn/docs/master/deploy-minio-on-docker-compose) 或者 [Swarm mode](http://docs.minio.org.cn/docs/master/deploy-minio-on-docker-swarm)进行部署。这两者之间的主要区别是Docker Compose创建了单个主机，多容器部署，而Swarm模式创建了一个多主机，多容器部署。
...
- [在Docker Compose上部署MinIO](http://docs.minio.org.cn/docs/master/deploy-minio-on-docker-compose)
- [在Docker Swarm上部署MinIO](http://docs.minio.org.cn/docs/master/deploy-minio-on-docker-swarm)
- [分布式MinIO快速入门](http://docs.minio.org.cn/docs/master/distributed-minio-quickstart-guide)
- [MinIO纠删码模式快速入门](http://docs.minio.org.cn/docs/master/minio-erasure-code-quickstart-guide)