...
MinIO服务正在使用别名`m1`运行。从MinIO客户端完整指南[MinIO客户端完全指南](http://docs.minio.org.cn/docs/master/minio-client-complete-guide)了解详情。MySQL备份存储在`mysqlbkp`目录下。
...
持续地将`mysqlbkp`文件夹中所有数据mirror到MinIO。更多`mc mirror`信息，请参考[这里](http://docs.minio.org.cn/docs/master/minio-client-complete-guide#mirror) 。
