...
[![Slack](https://slack.min.io/slack?type=svg)](http://slack.minio.org.cn/questions) [![Go Report Card](https://goreportcard.com/badge/minio/mc)](https://goreportcard.com/report/minio/mc) [![Docker Pulls](https://img.shields.io/docker/pulls/minio/mc.svg?maxAge=604800)](https://hub.docker.com/r/minio/mc/)
...
**注意:** 上述示例默认使用MinIO[演示环境](http://docs.minio.org.cn/docs/master/minio-client-quickstart-guide#test-your-setup)做演示，如果想用`mc`操作其它S3兼容的服务，采用下面的方式来启动容器：

```
docker run -it --entrypoint=/bin/sh minio/mc
```

然后使用[`mc config`命令](http://docs.minio.org.cn/docs/master/minio-client-quickstart-guide#add-a-cloud-storage-service)。
...
如果你打算仅在POSIX兼容文件系统中使用`mc`,那你可以直接略过本节，跳到[日常使用](http://docs.minio.org.cn/docs/master/minio-client-quickstart-guide#everyday-use)。
...
- [MinIO快速入门](http://docs.minio.org.cn/docs/master/minio-quickstart-guide)
