...
在stack成功部署之后，你可以通过[MinIO Client](http://docs.minio.org.cn/docs/master/minio-client-complete-guide) `mc` 或者浏览器访问http://[Node_Public_IP_Address]:[Expose_Port_on_Host]来访问你的MinIO server。
...
- [使用Docker Compose部署MinIO](http://docs.minio.org.cn/docs/master/deploy-minio-on-docker-compose)
