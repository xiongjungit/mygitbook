...
2. (可选) 如果你需要查看生成的文件，可以在 [job artifact](https://docs.gitlab.com/ee/user/project/pipelines/job_artifacts.html) 中找到。
...
- [在百度上搜索 “Hexo GitLab”](https://www.baidu.com/s?wd=Hexo GitLab)